...
import Gstreamlit_ghseets
from streamlit_ghseets import GSh
...
def main():
    st.sidebar.title('Lost Items Navigation')
    page = st.sidebar.selectbox("Select Page", ["Lost Items", "Report a Lost Item"])

    if page == "Lost Items":
        st.subheader("Lost Items")
        # Add content for the Home page

    elif page == "Report a Lost Item":
        st.subheader("Report a Lost Ite")
